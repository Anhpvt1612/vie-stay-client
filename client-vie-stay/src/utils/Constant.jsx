export const BASE_URL = "https://vie-stay-server.onrender.com";
...
export const text = {
  ...
  HOME_DESCRIPTION:
    "Tìm kiếm phòng trọ, nhà trọ tại Đà Nẵng với giá cả hợp lý, vị trí thuận tiện và đầy đủ tiện nghi. Cập nhật tin đăng mới nhất mỗi ngày.",
...
export const location = [
  {
    ...
    image:
      "https://vietnamdailytour.vn/wp-content/uploads/2022/08/ngu-hanh-son.2.jpg",
  ...
  },
  {
    ...
    image:
      "https://images2.thanhnien.vn/528068263637045248/2024/6/19/2-r-1718791886665772660374.jpg",
  ...
  },
  {
    ...
    image:
      "https://hellodanang.vn/wp-content/uploads/2025/01/quan-cam-le-phat-trien-1735808204.jpeg",
    districtCode: "cam-le",
  },
];
